...
public class TimeSyncAlgorithmException extends Exception {
    TimeSyncAlgorithmException(String msg) {
        super(msg);
    }

    TimeSyncAlgorithmException(String fmt, Object... args) {
        super(String.format(Locale.ENGLISH, fmt, (Object[]) args));
    }
}
